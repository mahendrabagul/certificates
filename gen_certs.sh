...
echo "==================================================================="
openssl req -nodes -new -keyout grpc-server.key -out grpc-server.csr -subj "/C=IN/ST=MH/L=Pune/O=KubeDaily/OU=DevSecOps Meetup/CN=devsecops.kubedaily.com" -config ../openssl.cnf -passout pass:1111
...
echo "==================================================================="
openssl req -nodes -new -keyout grpc-client.key -out grpc-client.csr -subj "/C=IN/ST=MH/L=Pune/O=KubeDaily/OU=DevSecOps Meetup/CN=node-grpc-client3" -config ../openssl.cnf -passout pass:1111
